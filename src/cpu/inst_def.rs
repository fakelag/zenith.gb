...
const INSTR_INDEX: [Instruction; 256] =  [
    ...
    /* 0x38 JR C e8      | - - - - */  Instruction(OperandKind::R8,         OperandKind::Imm8,       3,   opcode_jr),
    ...
    /* 0xD8 RET C        | - - - - */  Instruction(OperandKind::R8,         OperandKind::None,       5,   opcode_ret),
    ...
    /* 0xDC CALL C a16   | - - - - */  Instruction(OperandKind::R8,         OperandKind::Imm16_Addr, 6,   opcode_call),
